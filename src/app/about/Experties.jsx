        ...
        <>
            <div className='relative flex flex-col-reverse lg:flex-row gap-4 justify-center'>
                <div className='w-[100%] lg:w-[50%] flex flex-col gap-3 md:flex-row justify-evenly flex-wraps items-center'>
                    ...
                    className='border-solid border-2 w-[164px] border-[#8fab3a] px-8 py-4 flex flex-col justify-center items-center '>
                ...
                className='w-[100%] lg:w-[40%] h-[350px] overflow-hidden flex justify-center items-center'>
